...
- `openai-remote` - Uses OpenAI-compatible models through the MarkUs AI gateway (requires `GATEWAY_API_KEY` and `GATEWAY_SPEND_METADATA`, `--remote_url` for the gateway, default: `gpt-4o-mini`)
